...
type MessagesType = {
  ...
  'modals.simplebuy.checkout.buy.abovemax': 'The maximum amount of {coin} you can buy with your {currency} Account s account is {amount}'
  ...
  'modals.simplebuy.checkout.buymaxamount': 'The maximum amount of {coin} you can sell from this account is {amount}'
